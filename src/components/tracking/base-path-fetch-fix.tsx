 ...
 *
 * Inline script (not next/script) so it runs from the initial HTML before
 * Next client/runtime fetch.
 */
export function BasePathFetchFix() {
  const basePath = process.env.NEXT_PUBLIC_BASE_PATH || "/compare-stt-apis";
