 ...
 *
 * PostHog is guarded against double-init: GTM on gladia.io may already set
 * `window.posthog` to a real client. Re-running the snippet stubs methods that
 * call `.push()` on a non-array → `TypeError: t.push is not a function` and a
    ...
    <>
      ...
      <Script id="posthog" strategy="afterInteractive">{`
        (function () {
          ...
          // Real client (GTM or prior load) — do not re-stub methods on it.
